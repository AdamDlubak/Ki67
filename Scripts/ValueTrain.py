...
class ValueTrain(object):
    ...
    def worker(self, variables):
        ...
        self.result_table = self.optimizeFunctions.setDecisions([self.threshold_value], sorted_decision, variables)
        ...
        self.optimizeFunctions.saveResults(variables['results_folder'], ["ValueTrain", self.accuracy, self.precision[0], self.precision[1], self.recall[0], self.recall[1], self.fscore[0], self.fscore[1], self.support[0], self.support[1], print_threshold, measured_time])
